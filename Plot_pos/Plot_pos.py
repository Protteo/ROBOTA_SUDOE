...
"""This code does the exact same things than the one above, but adapted for vscode, since I first used Spyder instead of vscode."""
...
interval_update_sec = 1  # fréquence de mise à jour histogramme (en secondes)
num_capteurs = 6
port_serial = "COM3"  # adapte le port COM si nécessaire
baudrate = 9600
acquisition_active = True
