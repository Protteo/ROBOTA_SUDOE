...
class admittance_control(object):
    def __init__(self):
        ...
        rospy.Subscriber('/IK_publisher', WrenchStamped, self.force_callback) # sensor used to acquire forces 
        rospy.Subscriber("/joint_states", LinkStates, self.joint_state_callback)
    ...
    def admittance_openloop(self) :
        ...
        joint_vel_pub = rospy.Publisher('/joint_group_eff_controller/command', Float64MultiArray, queue_size=1)
